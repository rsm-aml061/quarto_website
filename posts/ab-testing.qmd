...
Since the data are binary, this is simply the difference in observed signup rates. In other words, this measures how much better one version performs compared to the other.
